...
NSArray<NSString *>* getIgnoreList() {
    NSString *configPath = [NSHomeDirectory() stringByAppendingString:@"/.config/waypoint/proxyIgnoreList.plist"];
...
int main(int argc, const char * argv[]) {
    ...
    SCPreferencesRef prefRef = SCPreferencesCreateWithAuthorization(nil, CFSTR("Waypoint"), nil, authRef);
