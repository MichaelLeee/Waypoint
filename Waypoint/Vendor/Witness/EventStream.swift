...
class EventStream {
    ...
    // Kept alive for the lifetime of the stream; FSEvents retains nothing.
    private let callbackQueue = DispatchQueue(label: "org.waypnt.waypoint.witness.events")
